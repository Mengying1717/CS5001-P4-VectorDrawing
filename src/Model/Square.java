...
public class Square extends Ellipse {
    ...
    public void draw(Graphics g) {
        ...
        if (isFill()) {
            g2d.fillRect(x1, y1, Math.min(Math.abs(y1 - y2), Math.abs(x1 - x2)), Math.min(Math.abs(y1 - y2), Math.abs(x1 - x2)));
        }
        g2d.drawRect(x1, y1, Math.min(Math.abs(y1 - y2), Math.abs(x1 - x2)), Math.min(Math.abs(y1 - y2), Math.abs(x1 - x2)));
    }
}